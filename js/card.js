/* =========================================================================
   ...
   URL parametreleri:
     data   = QR'a gömülecek katılımcı yükleme linki (zorunlu)
     title  = etkinlik başlığı (eski QR'lar için couple yedeği de okunur)
...
(function () {
  ...
  function build() {
    ...
    sheet.innerHTML = '';
    var coupleHtml = EVENT_TITLE ? esc(EVENT_TITLE) : esc(t('card.defaultTitle'));
