...
(function () {
  ...
  var DICT = {
    tr: {
      ...
      'setup.googleDesc': 'Fotoğraflar otomatik olarak Google Drive\'ınıza kaydedilir. Tek dokunuşla Drive\'ınızı bağlayın — kurulum gerektirmez.',
      'setup.googleSignIn': 'Google ile Bağlan',
      'setup.completeTitle': 'Google Drive Bağlantısı Hazır',
      'setup.completeDesc': 'Drive klasörünüz hazır. Şimdi etkinlik ayarlarını yapabilirsiniz.',
      'setup.reconnect': 'Yeniden Bağlan',
      'setup.rotateKey': 'Galeri anahtarını yenile',
      'setup.rotateOk': 'Galeri anahtarı yenilendi.',
      'setup.rotateFail': 'Galeri anahtarı yenilenemedi.',
      ...
      'setup.needAuth': 'Önce Google ile bağlanın.',
      'setup.oauthError': 'Google bağlantısı başarısız oldu ({code}). Lütfen tekrar deneyin.',
      ...
      'upload.sendCount': 'Gönder · {count} fotoğraf',
      'upload.retrySend': 'Tekrar Gönder ({count})',
      'upload.sendBarName': 'Göndermeden önce yukarıya adınızı yazın',
      'upload.sendBarWithNote': 'Fotoğraflar notunuzla birlikte gönderilecek',
      'upload.sendBarReady': 'Seçtiğiniz kareler gönderime hazır',
      'upload.noteFailAfterPhotos': 'Fotoğraflarınız yüklendi ancak notunuz gönderilemedi. "Gönder"e tekrar dokunursanız yalnızca notunuz yeniden denenir.',
      ...
      'upload.invalidEventHtml': '<b>Bu albüm bağlantısı geçersiz.</b> Lütfen QR kodu tekrar okutun veya paylaşılan güncel linki kullanın.',
      'upload.partialErrorHtml': '<b>{ok} fotoğraf yüklendi, {failed} tanesi başarısız.</b> İnternet bağlantınızı kontrol edip <b>Gönder</b>\'e tekrar dokunun — yalnızca eksik kalanlar yeniden yüklenir.',
      ...
      'gallery.failConnectionHtml': '<b>Bağlantı kurulamadı.</b> İnternet bağlantınızı kontrol edip sayfayı yenileyin.',
    ...
    en: {
      ...
      'setup.googleDesc': 'Photos are saved to your Google Drive automatically. One tap connects your Drive — nothing to install.',
      'setup.googleSignIn': 'Sign in with Google',
      'setup.completeTitle': 'Google Drive Connected',
      'setup.completeDesc': 'Your Drive folder is ready. Now configure your event below.',
      'setup.reconnect': 'Reconnect',
      'setup.rotateKey': 'Rotate gallery key',
      'setup.rotateOk': 'Gallery key rotated.',
      'setup.rotateFail': 'The gallery key could not be rotated.',
      ...
      'setup.oauthError': 'Google connection failed ({code}). Please try again.',
      ...
      'upload.sendCount': 'Send · {count} photos',
      'upload.retrySend': 'Retry ({count})',
      'upload.sendBarName': 'Add your name above before sending',
      'upload.sendBarWithNote': 'Photos will be sent together with your note',
      'upload.sendBarReady': 'Your photos are ready to send',
      'upload.noteFailAfterPhotos': 'Your photos were uploaded, but the note could not be sent. Tap "Send" again to retry just the note.',
      ...
      'upload.invalidEventHtml': '<b>This album link is invalid.</b> Please scan the QR again or use the latest shared link.',
      'upload.partialErrorHtml': '<b>{ok} photos uploaded, {failed} failed.</b> Check your connection and tap <b>Send</b> again — only the missing ones will be re-uploaded.',
      ...
      'gallery.failConnectionHtml': '<b>Could not connect.</b> Check your internet connection and refresh the page.',
