...
(function () {
  ...
  var DICT = {
    tr: {
      ...
      'setup.googleClientMissingHtml': 'Otomatik kurulum ("Google ile Bağlan") için <b>js/setup.js</b> içindeki <code>GOOGLE_CLIENT_ID</code> değerini ayarlayın (README, Bölüm B · Yol 1). Alternatif: Apps Script\'i kendiniz yayınlayıp Web App URL\'inizi <b>Gelişmiş ayarlar</b>dan girin.',
      ...
      'upload.verifying': 'Yükleme doğrulanıyor…',
      ...
      'upload.noteVerifyFail': 'Not gönderimi doğrulanamadı. İnternet bağlantınızı kontrol edip tekrar deneyin.',
      'upload.nameRequired': 'Lütfen adınızı yazın.',
      'upload.emptySend': 'Göndermek için fotoğraf seçin veya kısa bir not yazın.',
      'upload.verifyFail': '<b>Yükleme doğrulanamadı.</b> İnternet bağlantınızı kontrol edip <b>Gönder</b>\'e tekrar dokunun — aynı fotoğraflar iki kez kaydedilmez.',
    ...
    en: {
      ...
      'setup.googleClientMissingHtml': 'Automatic setup ("Sign in with Google") requires the <code>GOOGLE_CLIENT_ID</code> value at the top of <b>js/setup.js</b> (README, Section B · Path 1). Alternative: deploy Apps Script yourself and paste the Web App URL under <b>Advanced settings</b>.',
      ...
      'upload.verifying': 'Verifying upload…',
      ...
      'upload.noteVerifyFail': 'The note could not be verified. Check your connection and try again.',
      'upload.nameRequired': 'Please enter your name.',
      'upload.emptySend': 'Choose photos or write a short note before sending.',
      'upload.verifyFail': '<b>The upload could not be verified.</b> Check your connection and tap <b>Send</b> again — the same photos will not be saved twice.',
