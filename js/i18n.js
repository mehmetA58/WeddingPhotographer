...
(function () {
  ...
  var DICT = {
    tr: {
      ...
      'setup.coupleLabelHtml': '2 · Etkinlik Başlığı <span class="hint">(karşılama yazısında görünecek)</span>',
      ...
      'setup.needAuth': 'Önce Google hesabınızla bağlanın.',
    ...
    en: {
      ...
      'setup.coupleLabelHtml': '2 · Event Title <span class="hint">(shown on the welcome screen)</span>',
      ...
      'setup.needAuth': 'Connect with Google first.',
