...
(function () {
  ...
  var DICT = {
    tr: {
      ...
      'setup.coupleLabelHtml': '3 · Etkinlik Başlığı <span class="hint">(karşılama yazısında görünecek)</span>',
      'setup.couplePlaceholder': 'Örn. Ayşe & Mehmet, Kapadokya Gezisi, 30. Yaş',
      'setup.languageLabel': '4 · Dil',
      ...
      'setup.eventLabel': '2 · Etkinlik Türü',
    ...
    en: {
      ...
      'setup.coupleLabelHtml': '3 · Event Title <span class="hint">(shown on the welcome screen)</span>',
      'setup.couplePlaceholder': 'Example: Emma & Noah, Cappadocia Trip, 30th Birthday',
      'setup.languageLabel': '4 · Language',
